...
type raftNode struct {
	...
	confState     raftpb.ConfState // current raft config state
	snapshotIndex uint64           // index of the last snapshot
	appliedIndex  uint64           // index of the most recently applied commit
...
//
// param id: A unique number for this node
// param peers: A list of of the node's peers
// param join: Whether the node is joining an existing cluster
// param getSnapshot: A function to retrieve a representation of the current state machine
// param proposeC: A channel through which node propose changes to the state machine
// param confChangeC: A channel through which nodes propose cluster config changes
